...
map.getView().fit([1.378631, 6.111333, 1.730841, 6.325144], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DYNAMIQUE COTIERE DU LITTORAL TOGOLAIS </h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (464 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'ce projet est realisé dans le cadre de notre memoire de Master en SIG. Elle offre une analyse approfondie de la dynamique du littoral Togolais, mettant en evidence les tendances historiques de l\'évolution du littoral ainsi que, les scenarios de previsions optimiste et perssimiste ont permis de reférer de zones à risques; afin d\'encourager les responsables à prendre consciece de l\'ampleur du phénomème et à mettre en place des esures radicales pour le resoudre. ';
            }
